...
class Form_Field_DateSelector extends Form_Field
{
    ...
    public function setYearRange($from = null, $to = null)
    {
        if (!is_numeric($from)) {
            $from = null;
        }
    ...
    public function getInput($attr = array())
    {
        ...
        // day control
        $d = $this->getTag('select', array_merge(
            array(
                'id' => $this->name.'_day',
                'name' => $this->name.'_day',
                'onchange' => $onChange,
        ...
        // month control
        $m = $this->getTag('select', array_merge(
            array(
                'id' => $this->name.'_month',
        ...
        // year control
        $y = $this->getTag('select', array_merge(
            array(
                'id' => $this->name.'_year',
        ...
        $o1 = $this->date_order[0];
        $o2 = $this->date_order[1];
        $o3 = $this->date_order[2];
        $output .= $$o1.$$o2.$$o3;
