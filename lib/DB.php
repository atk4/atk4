...
class DB extends AbstractController
{
     ...
     *
     * TODO: test with PostgreSQL and other databases. I've heard pgsql does
     * not support autoincrements, but maybe we can pull some sequences then.
     * Yak, but we would need to know table name and some more info about the
     * statement, right?
     *
